        ...
        <div className="glass-card w-full max-w-md rounded-2xl p-8 sm:p-10 relative z-10 shadow-2xl border border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between mt-2">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="h-4 w-4 rounded border-gray-700 bg-gray-800 text-blue-500 focus:ring-blue-500 focus:ring-offset-gray-900 cursor-pointer"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-2.5 px-4 rounded-xl shadow-lg text-sm font-semibold text-white btn-gradient hover:opacity-95 transition-all mt-4 active:scale-95 disabled:opacity-50"
            >
              {isLoading ? (
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-[#111221] text-gray-400 rounded-full">
                Or continue with
              </span>
            </div>
          </div>
